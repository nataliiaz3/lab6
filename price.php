...
$price = array('price' => array( '$gte' => $_POST['minPrice'], '$lte' => $_POST['maxPrice'] ));
$cursor = $collection->find($price);

?>
<script type="text/javascript">
    localStorage.clear();
    localStorage.setItem("page", "price");
    localStorage.setItem("type", "price");
    localStorage.setItem("minPrice","<?echo $_POST["minPrice"];?>");
    localStorage.setItem("maxPrice", "<?echo $_POST["maxPrice"];?>");
</script>
